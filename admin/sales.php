...
<html lang="es">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
      ...
      <a class="navbar-brand mr-1" href="index.php">Restaurante <br> El secreto de Don Lucho</a>
            ...
            <div class="card-body">
              <table class="table table-bordered" width="100%" cellspacing="0">
                <tbody>
                  <tr>
                    <td>Hoy</td>
                    <td>S/. <?php echo getSalesGrandTotal("DAY"); ?> Soles</td>
                  </tr>
                  <tr>
                    <td>Esta Semana</td>
                    <td>S/. <?php echo getSalesGrandTotal("WEEK"); ?> Soles</td>
                  </tr>
                  <tr>
                    <td>Este Mes</td>
                    <td>S/. <?php echo getSalesGrandTotal("MONTH"); ?> Soles</td>
                  </tr>
                  <tr class="table-info">
                    <td><b>Todo el Tiempo</b></td>
                    <td><b>S/. <?php echo getSalesGrandTotal("ALLTIME"); ?> Soles</b></td>
                  </tr>
                </tbody>
              </table>
            </div>
        ...
        <footer class="sticky-footer">
          <div class="container my-auto">
            <div class="copyright text-center my-auto">
              <span>Copyright © Universidad de Ciencias y Humanidades 2021</span>
            </div>
          </div>
        </footer>
